      ...
      switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Congrats 😃! Your account is created successfully.');
...
exports.subscribeEmail = exports.requestVentilator = exports.makeDonation = exports.requestEmergencyHelp = exports.requestMedicalCheckup = exports.requestPacketMeal = exports.completeUserProfile = exports.updateSettings = void 0;
...
var completeUserProfile = function completeUserProfile(name, email, contactNumber, country, address, locality, city, state, zipCode, targetId, type) {
  var url, method, res;
  return regeneratorRuntime.async(function completeUserProfile$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          url = type === 'update' ? "http://127.0.0.1:3000/api/v1/profiles/".concat(targetId) : 'http://127.0.0.1:3000/api/v1/profiles';
        ...
        case 5:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "Profile ".concat(type.toUpperCase(), "d successfully!"));
          }
...
var requestPacketMeal = function requestPacketMeal(noOfPackage) {
  var url, res;
  return regeneratorRuntime.async(function requestPacketMeal$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          url = 'http://127.0.0.1:3000/api/v1/meals';
          _context3.next = 4;
          return regeneratorRuntime.awrap((0, _axios.default)({
            method: 'POST',
            url: url,
...
exports.requestPacketMeal = requestPacketMeal;

var requestMedicalCheckup = function requestMedicalCheckup(suspected, targetId) {
  var url, res;
  return regeneratorRuntime.async(function requestMedicalCheckup$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          url = "http://127.0.0.1:3000/api/v1/profiles/".concat(targetId);
          _context4.next = 4;
          return regeneratorRuntime.awrap((0, _axios.default)({
            method: 'PATCH',
            url: url,
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Reported successfully to COVID19 authority!');
          }
...
exports.requestMedicalCheckup = requestMedicalCheckup;

var requestEmergencyHelp = function requestEmergencyHelp(reportMeToCoronaAuth, targetId) {
  var url, res;
  return regeneratorRuntime.async(function requestEmergencyHelp$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          ...
          return regeneratorRuntime.awrap((0, _axios.default)({
            ...
            url: url,
            data: {
              reportMeToCoronaAuth: reportMeToCoronaAuth
            }
          }));
...
exports.requestEmergencyHelp = requestEmergencyHelp;

var makeDonation = function makeDonation(donationAmount) {
  var url, res;
  return regeneratorRuntime.async(function makeDonation$(_context6) {
    while (1) {
      switch (_context6.prev = _context6.next) {
        case 0:
          _context6.prev = 0;
          url = "http://127.0.0.1:3000/api/v1/donation";
          _context6.next = 4;
          return regeneratorRuntime.awrap((0, _axios.default)({
            method: 'POST',
            url: url,
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Hold on. we are processing...');
          }
...
var requestVentilator = function requestVentilator(requestorType, quantity) {
  var url, res;
  return regeneratorRuntime.async(function requestVentilator$(_context7) {
    while (1) {
      switch (_context7.prev = _context7.next) {
        case 0:
          _context7.prev = 0;
          url = "http://127.0.0.1:3000/api/v1/ventilators";
          _context7.next = 4;
          return regeneratorRuntime.awrap((0, _axios.default)({
            method: 'POST',
            url: url,
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Your request has been submit successfully!');
          }
...
exports.requestVentilator = requestVentilator;

var subscribeEmail = function subscribeEmail(email) {
  var url, res;
  return regeneratorRuntime.async(function subscribeEmail$(_context8) {
    while (1) {
      switch (_context8.prev = _context8.next) {
        ...
        case 4:
          ...
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'You have subscribed email updates successfully!');
          }
...
var createProfile = document.querySelector('.form-create-profile-data');
var updateProfile = document.querySelector('.form-update-profile-data');
var requestMeal = document.querySelector('.form-meal-data');
var suspected = document.querySelector('.form-suspect-data');
var reported = document.querySelector('.form-report-data');
var donate = document.querySelector('.form-donate-data');
var ventilator = document.querySelector('.form-ventilator-data');
...
if (updateProfile) updateProfile.addEventListener('submit', function _callee2(e) {
  var targetId, name, email, contactNumber, country, address, locality, city, state, zipCode;
  return regeneratorRuntime.async(function _callee2$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          e.preventDefault();
          targetId = document.getElementById('target-id').dataset.targetId;
          name = document.getElementById('name').value;
          email = document.getElementById('email').value;
          contactNumber = document.getElementById('mobileNumber').value;
          ...
          _context2.next = 13;
          return regeneratorRuntime.awrap((0, _updateSettings.completeUserProfile)(name, email, contactNumber, country, address, locality, city, state, zipCode, targetId, 'update'));
...
if (createProfile) createProfile.addEventListener('submit', function _callee3(e) {
  var targetId, name, email, contactNumber, country, address, locality, city, state, zipCode;
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          ...
          zipCode = document.getElementById('zip-code').value;
          _context3.next = 13;
          return regeneratorRuntime.awrap((0, _updateSettings.completeUserProfile)(name, email, contactNumber, country, address, locality, city, state, zipCode, targetId, 'create'));
...
if (createProfile) createProfile.addEventListener('submit', function _callee4(e) {
  var targetId, name, email, contactNumber, country, address, locality, city, state, zipCode;
...
if (requestMeal) requestMeal.addEventListener('submit', function _callee5(e) {
  var noOfPackage;
  return regeneratorRuntime.async(function _callee5$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          e.preventDefault();
          noOfPackage = document.getElementById('packet').value;
          _context5.next = 4;
          return regeneratorRuntime.awrap((0, _updateSettings.requestPacketMeal)(noOfPackage));
...
if (suspected) suspected.addEventListener('submit', function _callee6(e) {
  var targetId, suspectFlag, suspected;
  return regeneratorRuntime.async(function _callee6$(_context6) {
    while (1) {
      switch (_context6.prev = _context6.next) {
        case 0:
          e.preventDefault();
          targetId = document.getElementById('suspect').dataset.targetId;
          suspectFlag = document.getElementById('suspect').value;
          suspected = false;

          if (suspectFlag === '') {
            suspected = (_readOnlyError("suspected"), true);
          }

          _context6.next = 7;
          return regeneratorRuntime.awrap((0, _updateSettings.requestMedicalCheckup)(suspected, targetId));
...
if (reported) reported.addEventListener('submit', function _callee7(e) {
  var targetId, reportedFlag, reportMeToCoronaAuth;
  return regeneratorRuntime.async(function _callee7$(_context7) {
    while (1) {
      switch (_context7.prev = _context7.next) {
        case 0:
          e.preventDefault();
          targetId = document.getElementById('report').dataset.targetId;
          reportedFlag = document.getElementById('report').value;
          reportMeToCoronaAuth = false;

          if (reportedFlag === '') {
            reportMeToCoronaAuth = (_readOnlyError("reportMeToCoronaAuth"), true);
          }

          _context7.next = 7;
          return regeneratorRuntime.awrap((0, _updateSettings.requestEmergencyHelp)(reportMeToCoronaAuth, targetId));
...
if (donate) donate.addEventListener('submit', function _callee8(e) {
  var donationAmount;
  return regeneratorRuntime.async(function _callee8$(_context8) {
    while (1) {
      switch (_context8.prev = _context8.next) {
        case 0:
          e.preventDefault();
          donationAmount = document.getElementById('donate').value;
          ...
          _context8.next = 5;
          return regeneratorRuntime.awrap((0, _updateSettings.makeDonation)(donationAmount));
        ...
        case 7:
          (0, _alerts.showAlert)('error', 'Please enter amount to donate');
...
if (ventilator) ventilator.addEventListener('submit', function _callee9(e) {
  var requestorType, quantity;
  return regeneratorRuntime.async(function _callee9$(_context9) {
    while (1) {
      switch (_context9.prev = _context9.next) {
        case 0:
          e.preventDefault();
          requestorType = document.getElementById('type').value;
          ...
          _context9.next = 6;
          return regeneratorRuntime.awrap((0, _updateSettings.requestVentilator)(requestorType, quantity));
        ...
        case 8:
          (0, _alerts.showAlert)('error', 'Please provide the information.');
...
if (subscribe) subscribe.addEventListener('click', function _callee10(e) {
  var email;
    ...
    while (1) {
      switch (_context10.prev = _context10.next) {
        case 0:
          ...
          _context10.next = 5;
          return regeneratorRuntime.awrap((0, _updateSettings.subscribeEmail)(email));
        ...
        case 7:
          (0, _alerts.showAlert)('error', 'Please provide the correct email.');
